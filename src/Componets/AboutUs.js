            ...
            <Row  className="d-flex align-items-center justify-content-center pt-sm" style={{height:'100%'}}>
                    <Col>
                        ...
                        <p style={{fontSize: '1.3rem',color: '#00cdcb'}}>
                            ...
                            <a href='https://github.com/MoShouman' target="_blank">link</a>
                        </p>
                        <p style={{fontSize: '1.3rem',color: '#00cdcb'}}>
                            <i className="fa fa-linkedin" style={{marginRight:'7px'}}></i>
                            <a href='https://www.linkedin.com/in/moshouman/' target="_blank">link</a>
                        </p>
                        <p style={{fontSize: '1.3rem'}}><i className="fa fa-whatsapp" style={{color: '#00cdcb'}}></i> (+20)1016350644</p>
                    </Col>
                    <Col>
                        <div className='pt-sm' style={{ lineHeight: '12px'}}>
