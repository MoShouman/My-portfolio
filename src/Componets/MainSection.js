    ...
    return ( 
        <div id='mainSection' style={{backgroundColor:'#333647'}}>
            <Container  style={{height:'90vh'}}>
                <Row  className="d-flex align-items-center justify-content-center pt-sm" style={{height:'100%'}}>
                        <Col sm={12} md={6}>
                            <h5>Hello!</h5>
                            <h1 className='font-sm-1' style={{fontSize: '3.5rem', fontWeight:'700'}}>I'm Mohamed Ibrahim</h1>
                            <p  className='font-sm-2' style={{fontSize: '2rem', color: '#d3d2d0'}}>Frontend Developer | Software Engineer</p>
