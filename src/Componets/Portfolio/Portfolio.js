    ...
    return ( 
        <Container id='portfolio' className='mt-sm-3' style={{height:'100vh'}}>
            ...
            <Container className='p-2'>
                ...
                />
                 <Project projectName={'Dunkin Clone'} 
                         projectDesc={'Clone of Home, Menu, Products, and Product details pages of Dunkin website'}
                         projectLinks={['https://github.com/MoShouman/Dunkin-clone','https://dunkinclone.netlify.app/']}
                         tools={['React','Hooks','React Bootstrap','Firebase','FireStore','Netlify']}
                         imgSrc={'../../imgs/menuViewWeb.png'}
                         imgAlt={'Dunkin homepage'}
                />
